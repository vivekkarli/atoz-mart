...
public class S3ClientHelper {
	...
	public URL uploadFile(String key, MultipartFile file) {
		try {
			...
			throw new ProfileException("unable to upload file at the moment", HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public void createBucket(String bucket) {
		...
		try {
			...
			throw new ProfileException("bucket already exists", HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public byte[] getFile(String key) {
		try {
			...
			throw new ProfileException("unable to get file at the moment", HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
